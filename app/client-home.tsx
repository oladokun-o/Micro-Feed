        ...
        <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full border border-gray-300 hover:bg-gray-100 text-gray-800 font-medium py-3 px-4 rounded-lg transition flex items-center justify-center space-x-2"
            >
              <svg
                className="w05 h-5"
                viewBox="-3 0 262 262"
          ...
          <p className="text-sm text-gray-500 mt-6">
            You’ll need to sign in to create and interact with posts
          </p>
        </div>
      </div>
    );
